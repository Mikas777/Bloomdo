...
namespace Bloomdo.Server.Infrastructure.Migrations
{
    ...
    [Migration("20260405110429_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bloomdo.Server.Domain.Entities.ActivityItem", b =>
                {
                    ...
                    b.Property<string>("CustomVerificationCriteria")
                        .HasColumnType("text");
                    ...
                    b.Property<int?>("VerificationTemplateId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Bloomdo.Server.Domain.Entities.ChatConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bloomdo.Server.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bloomdo.Server.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bloomdo.Server.Domain.Entities.StreakFreeze", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bloomdo.Server.Domain.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bloomdo.Server.Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("Bloomdo.Server.Domain.Entities.ChatConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Bloomdo.Server.Domain.Entities.Notification", b =>
                {
                    b.HasOne("Bloomdo.Server.Domain.Entities.Account", "Actor")
                        .WithMany()
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Bloomdo.Server.Domain.Entities.Account", "Recipient")
                        .WithMany()
